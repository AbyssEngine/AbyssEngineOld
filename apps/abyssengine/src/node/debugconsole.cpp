...
DebugConsole::DebugConsole()
    : _consoleFont(std::filesystem::path{"/abyss-embedded/Hack-Regular.ttf"}, "Hack", 9, Cairo::FontOptions::HintStyle::MEDIUM, Cairo::ANTIALIAS_SUBPIXEL), _consoleLabel(_consoleFont), _inputLabel(_consoleFont) {
