...
class SDL2Texture : public ITexture {
  public:
    ...
    void SetColorMod(uint8_t red, uint8_t green, uint8_t blue) final;
    void SaveAsBMP(const std::string &filePath) final;
  ...
  private:
    ...
    void SaveTexture(SDL_Renderer *ren, SDL_Texture *tex, const char *filename);
};
