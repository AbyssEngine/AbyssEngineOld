macro(include_libvlc)
    ...
    if(DEFINED ENV{LIBVLC_COPY_PLUGINS})
        message(STATUS "Will copy VLC plugins from $ENV{LIBVLC_COPY_PLUGINS}")
        install(DIRECTORY "$ENV{LIBVLC_COPY_PLUGINS}/" DESTINATION bin/abyss-vlc-plugins)
    endif()
endmacro()
