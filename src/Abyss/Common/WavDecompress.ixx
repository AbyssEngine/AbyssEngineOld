...
export module Abyss.Common.WavDecompress;

namespace Abyss::Common {

export class WavDecompress {
  ...
  public:
    static auto decompress(const std::span<std::byte> &input, const uint8_t channelCount) -> std::vector<std::byte> {
